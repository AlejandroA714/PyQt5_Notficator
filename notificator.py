...
class notificator(QObject):
    ...
    def __new__(cls,QApp:QApplication=None):
    ...
    def __init__(self,QApp:QApplication=None):
        if not self.__instanced:
            ...
            #self.__app.aboutToQuit.connect(self.close)
            self.__instanced = True

    def critical(self,Title:str,Message:str,Parent:QMainWindow=None,Align:Align=TopRight,progressBar=False,duracion=15):
    ...
    def warning(self,Title:str,Message:str,Parent=None,Align:Align=TopRight,progressBar=False,duracion=15):
        if not Parent in self.UIContainer[Align]:
            self.UIContainer[Align][Parent] = []
        UI = UINotificationModal(Title,Message,Parent,Align,progressBar,
    ...
    def sucess(self,Title:str,Message:str,Parent=None,Align:Align=TopRight,progressBar=False,duracion=15):
        if not Parent in self.UIContainer[Align]:
            self.UIContainer[Align][Parent] = []
        UI = UINotificationModal(Title,Message,Parent,Align,progressBar,
    ...
    def info(self,Title:str,Message:str,Parent=None,Align:Align=TopRight,progressBar=False,duracion=15):
        if not Parent in self.UIContainer[Align]:
            self.UIContainer[Align][Parent] = []
        UI = UINotificationModal(Title,Message,Parent,Align,progressBar,
    ...
    def custom(self,Title:str,Message:str,backgroundColor:str,foregroundColor:str,icon:QPixmap,Parent=None,Align:Align=TopRight,progressBar:bool=False,duracion=15):
        if not Parent in self.UIContainer[Align]:
            self.UIContainer[Align][Parent] = []
    ...
    def close(self):
        #print("app closing")
        #self.__app.aboutToQuit.disconnect(self.close)
        self.destroy()
